...
$sid='';
	...
	if(isset($_SESSION['order']['c1']))
	{
		$str_qry.='c1='.$_SESSION['order']['c1'].'&';
		$c1=$_SESSION['order']['c1'];
	}
	if(isset($_SESSION['order']['c2']))
	{
		$str_qry.='c2='.$_SESSION['order']['c2'].'&';
		$c2=$_SESSION['order']['c2'];
	}
	if(isset($_SESSION['order']['c3']))
	{
		$str_qry.='c3='.$_SESSION['order']['c3'].'&';
		$c3=$_SESSION['order']['c3'];
	}
